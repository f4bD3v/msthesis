...
def main():
    ...
    for i in range(len(links)):
        ...
        header_1 = 'Market, State, Regulated, APMC Address, Secretary Address, Established (Year), Area Served/Catchment Area, Holidays, Hours, Permanent Staff, Temporary staff, Incoming Transport, Outgoging Transport, Railway Distance (km)'
